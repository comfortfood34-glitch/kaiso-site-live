...
export const menuCategories = [
  ...
  },
  {
    ...
    description: { es: 'Creaciones de fusión para disfrutarse con las manos.', pt: 'Criações de fusão para serem apreciadas com as mãos.', en: 'Fusion creations to enjoy with your hands.' },
    items: [
