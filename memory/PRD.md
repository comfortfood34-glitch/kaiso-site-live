...
- Analytics panel (/analytics) - visitor tracking, conversion funnel, device/language stats
- Menu section with allergen info, WhatsApp ordering
- Location section with Google Maps (Kaisō Sushi España)
- Email confirmations (customer + restaurant) - sent in BACKGROUND
...
- 2026-02-25: Added Analytics panel
- 2026-02-25: Fixed CORS issue (double slash in URL, moved middleware before routes)
- 2026-02-26: Fixed 30s reservation delay - emails now sent in background (0.19s response)
...
## Backlog
- Deploy permanente (Save to GitHub + Cloudflare rebuild)
